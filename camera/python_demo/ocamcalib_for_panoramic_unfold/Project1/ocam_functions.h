...
/*------------------------------------------------------------------------------
 ...
 a given TXT file
------------------------------------------------------------------------------*/
int ocam_unfold(int argc, char *argv[]);
...
void create_panoramic_CUBE(CvMat *mapx, CvMat *mapy, float Rmin, float Rmax, float xc, float yc, int i, struct ocam_model *myocam_model);
